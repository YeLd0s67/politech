                                    ...
                                    <td scope="row"> 
                                        <div class="row">
                                            <div class="col-sm-12 text-center">
                                                <button id="more" value="{{ $teacher->id }}" class="btn btn-primary btn-md"><a href='{{ route('view.teacher', ['id' => $teacher->id ]) }}' class="text-white">Көру</a></button>
