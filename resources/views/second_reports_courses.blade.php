...
@section('content')
    <h3 align="center">Біліктілігін арттыру курсы</h3>
    <br/>
    @auth
                    ...
                    <table id="course_table" class="table table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Курстың басталған уақыты</th>
                                <th scope="col">Курстың аяқталған уақыты</th>
